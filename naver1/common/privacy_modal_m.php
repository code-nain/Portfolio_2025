		...
		<br>
		 <div class="pri_modal_txt">
			<p>
				1. 개인정보 수집 및 이용의 목적
				<br><br>
				<?=$company?>(이하 '회사')는 회사가 제공하는 해당페이지에서 안내하는 상품 안내, 상품 가입, 비교견적 상담 등의 서비스 제공 및 신규 서비스의 개발 등의 목적으로 최소한으로 개인정보를 수집하고 있습니다.
				<br><br>
...
<style>
	.pri_modal_wrap h3 {background:#000; color:yellow; padding:15px; text-align:center; font-size:21px; }
		...
		<br>
		 <div class="pri_modal_txt2">
			<p>
				1.개인정보의 처리 목적
				<br><br>
				<?=$company?>(이하 '회사')는 회사가 제공하는 해당페이지에서 안내하는 상품 안내, 상품 가입, 비교견적 상담 등의
				...
				2) 개인정보 제공자는 해당 정보에 대한 동의를 거부할 수 있습니다.<br>
				...
				1) 회사가 수집하는 개인정보의 보유 및 처리 기간은 정보주체<br>가
				...
				정정을 완료하기 전까지 당해 개인정보를 이용 또는 제공하지 않습니다.<br>
				...
				외부로부터의 침입을 차단하는 장치를 이용하고 있으며,<br>
				각 서버마다 침입탐지시스템을 설치하여 24시간 침입을 감시하고 있습니다.
				<br><br>
				- 회사는 암호 알고리즘을 이용하여 네트워크상의<br>
				...
				참여자를 직접 상대하여 마케팅 업무를 수행하는 자.<br>
				개인정보관리책임자 및 담당자 등 개인정보관리업무를 수행하는 자.<br>
				기타 업무상 개인정보의 취급이 불가피한 자.<br>
				퇴사 또는 부서 이동 등 개인정보취급자가 변경될 경우 즉시 해당 계정을 통한 개인정보 접근 권한을 말소하고 있습니다. 또한 개인정보를 취급하는 직원을 대상으로 정기적인 개인정보 보안/관리 교육을 실시하고 있으면 이를 통해 개인정보취급자들이 항상 최상의 보안마인드를 가지도록 합니다.<br>
				개인정보관련 취급자의 업무 인수인계는 보안이 유지된 상태에서 이루어지며, 입사 및 퇴사 이후 개인 정보 사고에 대한 책임을 명확히 하고 있습니다.
				<br><br>
				10. 개인정보관리책임자
				<br><br>
				귀하의 개인정보를 보호하고 관련한 불만을 처리하기 위하여<br>
				회사는 개인정보관리책임자를 두어 귀하의 개인정보를 관리하고 있으며
				개인정보보호와 관련하여 귀하가 의견과 불만을 제기할 수 있는 창구를 개설하고 있습니다.<br>
				귀하의 개인정보와 관련한 문의사항 및 불만사항이 있으시면<br>
				아래의 개인정보관리 책임자에게 연락 주시면 즉시 조치하여 처리 결과를 통보하겠습니다.
				<br><br>
				[개인정보관리책임자]<br>
				이 름 : 신현수<br>
				이메일 : admin04121@nate.com<br>
				<br><br>
				11. 고지의 의무<br><br>	
...
<style>
	.pri_modal_wrap2 h3 {background:#000; color:yellow; padding:15px; text-align:center; font-size:21px;}

	.pri_modal_wrap2{ position: fixed; left: 50%; top: 0; transform: translateX(-50%); width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 99999999999; display: none; margin: 0 auto;}
	...
	.pri_modal_txt2 p{
		padding: 20px; line-height:2.0rem; font-size:21px;
	}
	.agree_close2 {
		position: sticky;
		width: 30px;

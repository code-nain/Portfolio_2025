...
/*보험료 산출 텍스트 css*/
	...
	.form-set div span.phone_num{color: #aaa;color: #000;font-weight:bold;width: 200px;font-size: 24px;line-height: 37px; padding: 0;}
	#inputform_2{width: auto;}
	.form-set #cellverify_auth_code{border: none; width: 360px; border-bottom: 2px solid #ddd; height: 68px; box-sizing: border-box;display: block;-webkit-appearance: none; -webkit-border-radius: 0;}
	...
	.form-set .inputform_2_space{margin-top: 30px; margin-bottom: 40px; border: none; display: block;}
	input#cellverify_auth_code{font-size: 26px;}
	
	.form-set #input_screen, .form-set #send_data, 	.form-set #input_screen, .form-set #send_data_price{height: 68px; width: 120px;border:none; cursor:pointer; background: var(--costBtncolor); color: #fff; font-size: 24px; padding: 5px; box-sizing: border-box; font-family: 'Pretendard';-webkit-appearance: none;
   -webkit-border-radius: 0;}
	#re_send_date{height: 68px; width: 120px;border:none; cursor:pointer; background: #333; color: #fff; font-size: 24px; padding: 5px; box-sizing: border-box; font-family: 'Pretendard';-webkit-appearance: none;
   -webkit-border-radius: 0;}

	.cost_popup_wrap_title{font-family: 'Pretendard'; font-weight: bold; width: 100%; background: #eee; position: absolute; left: 0; top: 0; padding-left: 30px; box-sizing: border-box; height: 100px; line-height: 110px; font-size: 26px;}

	.phone_num{display: block;}
	.num_check{border: none !important; display: flex; justify-content: space-between;}

	.form-set .phone_num_sub{display: block ; width: 100%; line-height: 1; margin-bottom: 20px; color: #888; padding: 0; font-size: 20px; margin-top: 5px;}
	.form-set #mobile1_num_check{width: 100px; box-sizing: border-box; height: 66px;}
	.form-set #mobile2_num_check{width: 260px; font-size: 26px;box-sizing: border-box; height: 66px;}
	...
	.form-set .num_check_inner{margin: 0 ; display: flex; border-bottom: none;}

	#mobile1_num_check{color: #000 !important; font-size: 26px; border: 0; border-bottom: 1px solid #ddd; outline: none; background: #fff;}
	#mobile2_num_check{color: #000 !important; font-size: 26px; border: 0; border-bottom: 1px solid #ddd; outline: none;}

	@media screen and (max-width: 670px) {
		.cost_popup_wrap {transform: translate(-50%,-50%) scale(0.5);}
	}
</style>
...
<div class ="cost_popup_wrap">
	...
	<div id="inputform_2" class="form-set" form action="" target="_self" >
		<h2 class="inputform_2_title" style="text-align: center; font-family: 'Pretendard'; width: 100%; letter-spacing: -1px; font-size: 24px; margin-top: 40px; font-weight: 500; color: #888">고객님의 연락처로 인증번호가 발송되었습니다.</h2>

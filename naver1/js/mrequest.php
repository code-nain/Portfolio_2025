 ...
 **/
define('__XE__',   TRUE);
define('_FILE_PATH_', str_replace('mrequest.php', '', str_replace('\\', '/', __FILE__)));
...
$request_vars['birthday'] = $request_vars['customer_birth'];
$request_vars['cellphone'] = $request_vars['mobile1'].$request_vars['mobile2'].$request_vars['mobile3'];
$request_vars['sex'] = $request_vars['sex_flag'] == '1' ? 'M' : 'F';
...
$output = (string)FileHandler::getRemoteResource('http://idb2.kro.kr/', http_build_query($request_vars), 3, 'POST', 'application/json');
